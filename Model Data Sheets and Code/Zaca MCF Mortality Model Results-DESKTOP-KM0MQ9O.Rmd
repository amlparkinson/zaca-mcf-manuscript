...
******WOULD LIKE TO GET DNBR AND RDNBR TO COMPARE TO OUR ESTIMATES FOR MORTALITY!!*******
...
for (i in 1:50)
{
  ...
  #random forest model
  rfm <- randomForest(tc_mortality ~ rain + tmax + TPI_five + dem_10m_zaca + flow_accumulation + sr + slope + TWI + cwd + vpd_aug + ridge + drainage_association + ndvi, data = train, ntree=1500, importance=T, nscale=0)
