...
mcf_tc_samplesize <- mcf %>% group_by(tc_mortality) %>%count() #type converted n = 99
mcf_tc_samplesie <- mcf %>% group_by(rdnbr_tc) %>%dplyr::count() # type converted n = 55 (almost too small to use)
mcf_tc_samplesie <- mcf %>% group_by(rdnbr_qualitative) %>%dplyr::count() # high=66, low= 585, moderate=272, type converted n = 84 
...
mcf_model <- mcf %>% 
  dplyr::select(rdnbr_tc, tmin_jan2007, tmax, vpd_aug, cwd, rain, sr, slope, aspect_transformed, TWI, ndmi_2006, evi_2006, tslf) # not sure if fri and years so fire, whic sounds like Time Since Last Fire, are the same thing

# run tuneRanger
mcf_task <- makeClassifTask(data = mcf_model, target = "rdnbr_tc")
...
# 4 rdnbr classes
mcf_model3 <- mcf %>% 
  dplyr::select(rdnbr_qualitative, tmin_jan2007, tmax, vpd_aug, cwd, rain, sr, slope, aspect_transformed, TWI, ndmi_2006, evi_2006, tslf) # not sure if fri and years so fire, whic sounds like Time Since Last Fire, are the same thing
...
# predictors 
nlm_predictor <- Predictor$new(rfm, data = mcf_ale, y = mcf_ale$rdnbr_qualitative, type = "prob", class="NLM")
...
ggsave(here::here("Graph Images", "mcf all ulm.jpg"), width=8, height = 8)

ggarrange(high1,high2,high3,high4,high5,high6,high7,high8,high9,high10,high11,high12, nrow=3, ncol=4)
ggsave(here::here("Graph Images", "mcf all high.jpg"), width=8, height = 8)

ggarrange(tc1,tc2,tc3,tc4,tc5,tc6,tc7,tc8,tc9,tc10,tc11,tc12, nrow=3, ncol=4)
ggsave(here::here("Graph Images", "mcf all tc.jpg"), width=8, height = 8)
...
# select variables to be used in the model
pico_model2 <- pico %>% dplyr::select(rdnbr_tc, tmax, vpd_aug, cwd, rain, insolation, slope, aspect_transformed, TWI, ndmi_2006, evi_2006, years_since_burn, tmin_jan2007, ndmi_2006) 
...
#ndmi
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "ndmi_2006")) + ggtitle("NLM") + labs(x="") + theme_classic() + scale_y_continuous(lim = c(-0.15, 0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#solar radiation
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "insolation")) + ggtitle("NLM") + labs(x="") + theme_classic() + scale_y_continuous(lim = c(-0.15, 0.2)) +  theme(axis.text.x = element_text(angle = 15, hjust = 0.85)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#precip
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "rain")) + ggtitle("NLM") + labs(x="") + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#tmax
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "tmax")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#tmin jan 2007
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "tmin_jan2007")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#vpd aug
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "vpd_aug")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#cwd
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "cwd")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#evi
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "evi_2006")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#slope
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "slope")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#tslf
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "years_since_burn")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#twi
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "TWI")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
...
#aspect
nlm <- plot(FeatureEffect$new(nlm_predictor, feature = "aspect_transformed")) + ggtitle("NLM") + labs(x="")  + theme_classic() + scale_y_continuous(lim = c(-0.15,0.2)) + theme(plot.margin = unit(c(d,1,1,1), "lines"))
